...
import { Canvas2D } from "./models/misc/Canvas2D";
...
export const Experience = () => {
  ...
  return (
    <>
      ...
      {/*<Canvas2D el={"f"} position={[-20, 2, -120]} rotation={[0, Math.PI/2, 0, 1]} />*/}

      {/*<Canvas2D el={"f"} position={[-49, 2, -130]} rotation={[0, 0.34, 0, 1]} />*/}
      <Canvas2D el={"f"} position={[-70, 2, -190]} rotation={[0, 0, 0, 1]} />
